...
public class Ex01_String {
	...
	public static void main(String[] args) {
		...
		*/		
		...
		String replacedIp = ip.replaceAll(".", "_"); // 192_168_101_01를 기대
		...
		// 단, jpg, git, pan 이미지인 경우에만 작업을 진행한다.
		...
		// 연습. 문자열 "abc12345def67890ghijl"에서
		// 아라비아 숫자 12345, 67890을 제외하고 한 글자씩 화면에 출력하시오.
		String str = "abc12345def67890ghijl"; 

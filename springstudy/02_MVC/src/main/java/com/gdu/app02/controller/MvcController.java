...
public class MvcController {
	...
	*/
	...
	//	@RequestMapping(value="/animal", method=RequestMethod.GET), method=RequestMethod.GET)
	//	@RequestMapping(value="animal", method=RequestMethod.GET), method=RequestMethod.GET)	슬래시가 없어도 됩니다.
	...
	// <a href="${contextPath}/want/animal?filename=animal3.jpg">	
	@RequestMapping("want/animal")
	public String 동물3보기(HttpServletRequest request) {
		
		System.out.println(request.getParameter("filename"));
		
		return "gallery/animal3";
		
	
	}
	
	// <a href="${contextPath}/reponse">

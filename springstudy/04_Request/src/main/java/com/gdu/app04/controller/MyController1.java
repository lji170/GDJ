...
@RequestMapping("member")	// URL Mapping member로 시작하는 모든 요청을 처리하는 컨트롤러
@Controller
public class MyController1 {
	...
	// location.href="${contextPath}/member/detail12?id=admin&pw=1234';
	@GetMapping("detail2")
	...
	@GetMapping("detail3")
	public String detail3(String id, // @RequestParma은 생략할 수 있다. 파라미터 id가 없는 경우 null이 저장된다.
						  String pw, // @RequestParma은 생략할 수 있다. 파라미터 pw가 없는 경우 null이 저장된다.
						  Model model) {
